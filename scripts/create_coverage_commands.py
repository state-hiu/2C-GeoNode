...
curl -u admin:geoserver -v -XPOST -H 'Content-type: text/xml' \\
     ...
     "https://2c.puerti.co/geoserver/rest/workspaces/geonode/coveragestores?configure=all"
"""
...
curl -u admin:geoserver -v -XPOST -H 'Content-type: text/xml' \\
      ...
      "https://2c.puerti.co/geoserver/rest/workspaces/geonode/coveragestores/%(name)s/coverages"
"""
